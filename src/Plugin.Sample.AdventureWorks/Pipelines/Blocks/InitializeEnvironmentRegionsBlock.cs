...
namespace Plugin.Sample.AdventureWorks
{
    ...
    public class InitializeEnvironmentRegionsBlock : AsyncPolicyTriggerConditionalPipelineBlock<string, string>
    {
        ...
        public override async Task<string> RunAsync(string arg, CommercePipelineExecutionContext context)
        {
            ...
            await _addEntitiesPipeline.RunAsync(new PersistEntitiesArgument(persistEntitiesArgument), context).ConfigureAwait(false);
            return arg;
        }
    }
}
