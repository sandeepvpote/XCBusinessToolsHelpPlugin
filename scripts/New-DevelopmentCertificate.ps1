...
$devEngineDirectory = "C:\development\BusinessToolHelp\Sitecore.Commerce.Engine.SDK\src\Sitecore.Commerce.Engine\wwwroot"
...
Copy-Item $pfxPath -Destination $devEngineDirectory -force
Copy-Item $cerPath -Destination $devEngineDirectory -force